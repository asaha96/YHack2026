...
export const SUBTITLE_SCRIPT: SubtitleEntry[] = [
  ...
  { from: 195, to: 275, text: "Surgery prep today? Mostly vibes and textbooks." },
  ...
  { from: 712, to: 788, text: "(Not a stock photo from 1987.)",                       style: "whisper" },
  ...
  { from: 1173, to: 1250, text: "Print it. Frame it. Impress your attendings.",       style: "whisper" },
  ...
  { from: 1525, to: 1578, text: "Practice makes perfect. Now you can.",               style: "whisper" },
];
